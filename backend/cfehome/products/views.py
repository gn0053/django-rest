...
class ProductLisCreatetAPiView(UserQuerysetMixin, StaffEditorPermissionMixin, generics.ListCreateAPIView):
    ...
    def perform_create(self, serializer):
        # email = serializer.validated_data.pop("email") # get temp data
